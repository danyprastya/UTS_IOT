...
const char *mqtt_topic = "danyutsmantapuhuy";     // MQTT topic
const char *mqtt_username = "dany";  // MQTT username for authentication
const char *mqtt_password = "dany";  // MQTT password for authentication
